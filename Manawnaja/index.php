		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top">
				<div class="container">
					<div class="row">
						<div class="col-xs-4">
							<p class="site">www.Japanhotel.com</p>
						</div>
						<div class="col-xs-8 text-right">
							<p class="num">Call: 02-987456</p>
			...
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.php">Japanhotel</a></div>
						</div>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Welcome to the Japanhotel</h2>
				   					<h1>A Japan Hotel</h1>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h1>Everything you need in Japanhotel</h1>
										<p><a class="btn btn-primary btn-demo" href="#"></i> View Detail</a> <a class="btn btn-primary btn-learn">Know More</a></p>
				   				</div>
				   			</div>
				   		</div>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h1>In the heart of Japanhotel</h1>
										<p><a class="btn btn-primary btn-demo" href="#"></i> View Detail</a> <a class="btn btn-primary btn-learn">Know More</a></p>
				   				</div>
				   			</div>
				   		</div>
						...
						<div class="owl-carousel owl-carousel2">
							<div class="item">
								...
								<div class="desc text-center">
									...
									<h3><a href="rooms-suites.php">Suite</a></h3>
									<p class="price">
										<span class="currency">฿</span>
										<span class="price-room">1,500</span>
							...
							<div class="item">
								...
								<div class="desc text-center">
									...
									<h3><a href="rooms-suites.php">Double Room</a></h3>
									<p class="price">
										<span class="currency">฿</span>
										<span class="price-room">2,500</span>
										<span class="per">/ per night</span>
									</p>
									<ul>
							...
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.php">Family Room</a></h3>
									<p class="price">
										<span class="currency">฿</span>
										<span class="price-room">3,800</span>
										<span class="per">/ per night</span>
									</p>
									<ul>
							...
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.php">Classic Double Room</a></h3>
									<p class="price">
										<span class="currency">฿</span>
										<span class="price-room">1,690</span>
										<span class="per">/ per night</span>
									</p>
									<ul>
										<li><i class="icon-check"></i> Only 10 rooms are available</li>
							...
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.php">Superior Double Room</a></h3>
									<p class="price">
										<span class="currency">฿</span>
										<span class="price-room">3,900</span>
										<span class="per">/ per night</span>
									</p>
									<ul>
										<li><i class="icon-check"></i> Perfect for traveling couples</li>
							...
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.php">Superior Family Room</a></h3>
									<p class="price">
										<span class="currency"><small>฿</small></span>
										<span class="price-room">4,990</span>
										<span class="per">/ per night</span>
									</p>
									<ul>
										<li><i class="icon-check"></i> Perfect for traveling couples</li>
										...
										<div class="col-md-12">
							              ...
							              <li>
							                ...
							                <div class="text">
							                  ...
							                  <h3>Fried Egg</h3>
							                  <p class="cat">Egg/ Potatoes / Ham</p>
							                </div>
							              </li>
							            </ul>
										</div>
								...
								<div role="tabpanel" class="tab-pane" id="desserts">
									<div class="row">
										<div class="col-md-12">
											<ul class="menu-dish">
							              <li>
							                <figure class="image"><img src="images/74.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">฿369</span>
							                  <h3>Honey Waffles Fruit</h3>
							                  <p class="cat">Honey / Waffles / Fruit</p>
							                </div>
							              </li>
							              <li>
							                <figure class="image"><img src="images/33.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">฿430</span>
							                  <h3>Pudding Egg</h3>
							                  <p class="cat">Pudding Egg / Honey /  Fruit</p>
							                </div>
							              </li>
							              <li>
							                <figure class="image"><img src="images/122.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">฿320</span>
							                  <h3>Puddingmilk Honey BerryFruit</h3>
							                  <p class="cat">Puddingmilk / Honey / BerryFruit</p>
							                </div>
							              </li>
							              <li>
							                <figure class="image"><img src="images/44.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">฿550</span>
							                  <h3>Ice Cream Cheese Crackers</h3>
							                  <p class="cat">Icecream / Cheese / Crackers</p>
							                </div>
							              </li>
							            </ul>
										</div>
										...
										<div class="col-md-12">
							              ...
							              <li>
							                ...
							                <div class="text">
							                  ...
							                  <h3>Juice</h3>
							                  <p class="cat">Orange / watermelon / grape / Seasonal Fruit</p>
							                </div>
							              </li>
							              <li>
							              ...
							              <li>
							                <figure class="image"><img src="images/81.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">฿150</span>
							                  <h3>cocktail</h3>
							                  <p class="cat">Margarita / Daiquiri / Negroni</p>
							                </div>
							              </li>
							              <li>
							                <figure class="image"><img src="images/91.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">฿280</span>
							                  <h3>Set Morning drink</h3>
							                  <p class="cat">coffee / Toast / Fried egg and sausage</p>
							                </div>
							              </li>
							            </ul>
										</div>
			...
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-3 col-md-push-1">
						...
						<ul class="colorlib-footer-links">
							<li>253 Asoke Building Sukhumvit <br>21 Soi 3, Klongtoey, Wattana,  <br> Bangkok 10110 Thailand</li>
							<li><a href="tel://02-987456">02-987456</a></li>
							<li><a href="mailto:nattisarapon@gmail.com">nattisarapon@gmail.com</a></li>
							<li><a href="http://Japanhotel.com">Japanhotel.com</a></li>
						</ul>
					</div>
				</div>
				<div class="row">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Thanks to all guests who use our service. <i class="icon-heart3" aria-hidden="true"></i> by <a href="#" target="_blank">Japanhotel</a>
